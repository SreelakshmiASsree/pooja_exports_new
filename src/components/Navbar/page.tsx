            ...
            {[
              ...
              <li key={link.title}>
                <button
                  ...
                  className={`lg:text-lg font-normal py-1 px-5 rounded-xl hover:bg-[#ffe2e2] ${isActive(link.path)
              ...
              <div className="flex flex-col gap-4 justify-center items-center">
                {[
                  ...
                  <button
                    key={link.title}
                    onClick={() => handleNavigation(link.path)}
                    className={`transition px-4 py-2 rounded hover:text-white hover:bg-[#D73543] ${isActive(link.path)
